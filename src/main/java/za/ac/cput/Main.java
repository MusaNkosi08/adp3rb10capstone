...
//        System.out.println("\n=== PAYMENTS ===");
//        za.ac.cput.views.Payment payment1 = new za.ac.cput.views.Payment.Builder()
//                .setPaymentId("P001")
//                .setAmount(150.75)
//                .setStatus("Pending")
...
//
//        za.ac.cput.views.Payment payment2 = new za.ac.cput.views.Payment.Builder()
//                .setPaymentId("P002")
//                .setAmount(299.99)
//                .setStatus("Completed")
...
//
//        za.ac.cput.views.Payment payment3 = new za.ac.cput.views.Payment.Builder()
//                .setPaymentId("P003")
//                .setAmount(75.50)
//                .setStatus("Refunded")
...
//        List<za.ac.cput.views.Payment> payments = new ArrayList<>();

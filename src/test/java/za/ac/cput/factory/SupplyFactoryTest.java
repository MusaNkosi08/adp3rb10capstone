...
class SupplyFactoryTest {
    ...
    void testCreateSupplySuccess() {
        ...
        Supply supply = SupplyFactory.createSupply("SUP001", 100.50, 10, "ABC Supplies");
    ...
    void testCreateSupplyWithEmptyOrderID() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                SupplyFactory.createSupply("", 100.50, 10, "ABC Supplies"));
    ...
    void testCreateSupplyWithEmptySupplierName() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                SupplyFactory.createSupply("SUP002", 100.50, 10, ""));
    ...
    void testCreateSupplyWithNegativeOrderPrice() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                SupplyFactory.createSupply("SUP003", -50.00, 10, "XYZ Distributors"));
    ...
    void testCreateSupplyWithNegativeQuantity() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                SupplyFactory.createSupply("SUP004", 100.00, -5, "LMN Traders"));
